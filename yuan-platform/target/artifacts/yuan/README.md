...
According to LGPL-2.1 requirements:



You may freely use this project



If you modify the Docking Frames library, you must open-source the modified code



Users have the right to replace the Docking Frames library version
