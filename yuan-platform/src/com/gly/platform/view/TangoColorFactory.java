...
public class TangoColorFactory {
    ...
    private static final Color CHAMELEON_1 = new Color(138, 226, 52);
    private static final Color CHAMELEON_2 = new Color(115, 210, 22);
    private static final Color CHAMELEON_3 = new Color(78, 154, 6);
    private static final Color BUTTER_1 = new Color(252, 233, 79);
    private static final Color BUTTER_2 = new Color(237, 212, 0);
    private static final Color BUTTER_3 = new Color(196, 160, 0);
    private static final Color SKY_BLUE_1 = new Color(114, 159, 207);
    private static final Color SKY_BLUE_2 = new Color(52, 101, 164);
    private static final Color SKY_BLUE_3 = new Color(32, 74, 135);
    private static final Color CHOCOLATE_1 = new Color(233, 185, 110);
    private static final Color CHOCOLATE_2 = new Color(193, 125, 17);
    private static final Color CHOCOLATE_3 = new Color(143, 89, 2);
    private static final Color MAGENTA = new Color(255, 0, 255);
    private static final Color PLUM_1 = new Color(173, 127, 168);
    private static final Color PLUM_2 = new Color(117, 80, 123);
    private static final Color PLUM_3 = new Color(92, 53, 102);

    private static final Color SCARLET_1 = new Color(239, 41, 41);
    private static final Color SCARLET_2 = new Color(204, 0, 0);
    private static final Color SCARLET_3 = new Color(164, 0, 0);
    private static final Color ORANGE_1 = new Color(252, 175, 62);
    private static final Color ORANGE_2 = new Color(245, 121, 0);
    private static final Color ORANGE_3 = new Color(206, 92, 0);

    public static final Color ALUMINIUM_1 = new Color(238, 238, 236);
    public static final Color ALUMINIUM_2 = new Color(211, 215, 207);
    private static final Color ALUMINIUM_3 = new Color(186, 189, 182);
    private static final Color ALUMINIUM_4 = new Color(136, 138, 133);
    public static final Color ALUMINIUM_5 = new Color(85, 87, 83);
    private static final Color ALUMINIUM_6 = new Color(46, 52, 54);

    // Scarlet and orange are reserved for hard and soft constraints
    private static final List<Color> SEQUENCE_1 = unmodifiableList(asList(TangoColorFactory.CHAMELEON_1,
            TangoColorFactory.BUTTER_1, TangoColorFactory.SKY_BLUE_1, TangoColorFactory.CHOCOLATE_1,
            TangoColorFactory.PLUM_1));
    private static final List<Color> SEQUENCE_2 = unmodifiableList(asList(TangoColorFactory.CHAMELEON_2,
            TangoColorFactory.BUTTER_2, TangoColorFactory.SKY_BLUE_2, TangoColorFactory.CHOCOLATE_2,
            TangoColorFactory.PLUM_2));
    private static final List<Color> SEQUENCE_3 = unmodifiableList(asList(TangoColorFactory.CHAMELEON_3,
    ...
    private static final Stroke FAT_DASHED_STROKE = new BasicStroke(
    ...
    private static final Stroke LIGHT_DASHED_STROKE = new BasicStroke(
            1.0f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 1.0f, new float[]{3.0f, 7.0f}, 0.0f);

    private static Color buildPercentageColor(Color floorColor, Color ceilColor, double shadePercentage) {
        return new Color(
